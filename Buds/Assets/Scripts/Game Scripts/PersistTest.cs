...
public class PersistTest : MonoBehaviour
{
    ...
    {
    	PersistentData.instance.exampleVar = value; //general format for writing to the singleton
    ...
    public void readVal()
    {
    	SetText("Read exampleVar: " + PersistentData.instance.exampleVar); //general format for reading from the singleton
    }
